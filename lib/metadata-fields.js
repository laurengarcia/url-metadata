...
function MetadataFields (options) {
  ...
  this.fields = {
    ...
    performance: {},
    canonical: '', // first <link rel="canonical"> found, empty string if none
    canonicalUrls: [], // raw href of every canonical tag, in document order
    lang: '',
    hreflang: [],
    charset: '',
    viewport: '',
    ...
    priceCurrency: '',
    availability: '',
    jsonld: [], // arbitrary schema.org shapes, shapes vary by page (schema.org types, often malformed)
    ...
    headings: [],
    imgTags: [],
    responseBody: '' // empty string unless options.includeResponseBody is true
  }
